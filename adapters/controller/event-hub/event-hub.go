...
func NewEventHub(svc model.IService, conf EventHubConfig) (IEventHub, error) {
	...
	blobConnectionString := "DefaultEndpointsProtocol=https;AccountName=oemalarmstorage;AccountKey=SYenJfAUMJCgzZrSYHB5hUI7nTSb86Q30JrxtnF3KLNiMKIOFl4aO3eC6YJkh+iOj9iZuu2VOlzl+AStaoecFQ==;EndpointSuffix=core.windows.net"
